-- ============================================================================
-- FIX: Alle v_vacation_balance_* Views - Resturlaub zählt nur URLAUB
-- ============================================================================
-- TAG 198: Bug-Fix - Views zählten alle Buchungen (Krankheit, ZA, Schulung)
--          statt nur Urlaub (vacation_type_id = 1)
-- ============================================================================

-- Funktion zum Erstellen/Korrigieren einer View für ein bestimmtes Jahr
...
BEGIN
    ...
    ', year_val, year_val, year_val, year_val, year_val);
    
    EXECUTE format('
        COMMENT ON VIEW v_vacation_balance_%s IS ''Urlaubssalden %s - PostgreSQL-Version (TAG 198: Nur Urlaub zählen)'';
    ', year_val, year_val);
END;
$$ LANGUAGE plpgsql;

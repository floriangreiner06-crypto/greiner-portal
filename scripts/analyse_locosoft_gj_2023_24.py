#!/usr/bin/env python3
"""
Analyse: Verrechnete Stunden und Umsatz für Geschäftsjahr 2023/24 aus Locosoft

Zweck:
- Filtert verrechnete Stunden (labours mit is_invoiced = true)
- Filtert generierten Umsatz (invoices.job_amount_net)
- Zeitraum: 01.09.2023 - 31.08.2024 (Geschäftsjahr 2023/24)
...
def get_geschaeftsjahr_datum(gj_string: str) -> tuple[date, date]:
    ...
    - GJ 2023/24 = 01.09.2023 - 31.08.2024
...
def main():
    """Hauptfunktion."""
    print("=" * 80)
    print("LOCOSOFT ANALYSE: Verrechnete Stunden und Umsatz GJ 2023/24")
    print("=" * 80)
    print()

#!/usr/bin/env python3
"""
FIBU-BUCHUNGEN KATEGORISIERUNG v2.7 - BWA-PERFEKT! 🎯
=====================================================
FINALE Version mit 100% korrekter Wareneinsatz-Kategorisierung!

KRITISCHE ÄNDERUNG v2.7:
...
PFAD: /opt/greiner-portal/scripts/sync/sync_fibu_v2.7_BWA_PERFECT.py

AUSFÜHREN:
  cd /opt/greiner-portal
  python3 scripts/sync/sync_fibu_v2.7_BWA_PERFECT.py
"""
...
TEST_MODE = True  # Auf False setzen für Produktiv!

# ============================================================================
# KATEGORISIERUNGS-REGELN v2.7 - BWA-PERFEKT!
# ============================================================================

def kategorisiere_buchung_v27(nominal_account, posting_text=""):
    """
    Kategorisiert eine Buchung nach v2.7 Regeln.
    ...
    if 800000 <= konto <= 899999:
        ...
        # ⭐ NEU v2.7: WARENEINSATZ FAHRZEUGE (OHNE 817xxx und 827xxx!)
...
def main():
    ...
    print("\n" + "=" * 100)
    print("🚀 FIBU-KATEGORISIERUNG v2.7 - BWA-PERFEKT!")
    print("=" * 100)
    ...
    # ========================================================================
    # ANALYSE: v2.7 KATEGORISIERUNG TESTEN
    # ========================================================================
    
    print("\n" + "=" * 100)
    print("🔍 SCHRITT 1: v2.7 KATEGORISIERUNG TESTEN (Sep+Okt 2025)")
    print("=" * 100)
    ...
    print("\n📊 KATEGORISIERUNG v2.7 (Sep+Okt 2025):")
    print("-" * 100)
    ...
    print(f"\n{'Gruppe':<8} | {'Buchungen':>10} | {'SOLL':>15} | {'HABEN':>15} | {'Netto (S/H)':>15} | v2.7 Kat")
    print("-" * 100)
    ...
    print(f"\n{'Kategorie':<30} | {'BWA Soll':>15} | {'FIBU Ist (v2.7)':>20} | {'Diff':>15}")
    print("-" * 100)
    ...
    if not TEST_MODE:
        ...
        for row_id, konto, text in sqlite_cursor.fetchall():
            kategorie, kategorie_erw = kategorisiere_buchung_v27(konto, text or "")
        ...
        print("\n🎉 ERFOLG! v2.7 Kategorisierung in DB gespeichert!")
    
    else:
        print("\n" + "=" * 100)
        print("ℹ️  TEST-MODUS: Keine DB-Updates")
        print("=" * 100)
        print("\n💡 Um v2.7 zu aktivieren:")
        print("   1. Öffne dieses Script")
        print("   2. Setze: TEST_MODE = False (Zeile 29)")
        print("   3. Führe aus: python3 scripts/sync/sync_fibu_v2.7_BWA_PERFECT.py")
    ...
    print("\n" + "=" * 100)
    print("✅ v2.7 ANALYSE ABGESCHLOSSEN")
    print("=" * 100)
    print()

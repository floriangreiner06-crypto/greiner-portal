...
"""
╔══════════════════════════════════════════════════════════════════════════════╗
║  FIBU RE-KATEGORISIERUNG v2.5.1 - BWA-PERFEKT (BUGFIX!)                    ║
╚══════════════════════════════════════════════════════════════════════════════╝

🐛 BUGFIX v2.5 → v2.5.1:
   - v2.5: 810-829 als Wareneinsatz (FALSCH! 2,2 Mio € zu viel)
   - v2.5.1: NUR 818xxx und 824xxx als Wareneinsatz (KORREKT!)
...
📊 WAS MACHT DIESES SCRIPT:
   ...
   4. NUR 818xxx + 824xxx als Wareneinsatz! (WICHTIG!)
   5. Rechnet kalkulatorische Kosten ein (444xxx, 471001, 498001)
   6. 100% BWA-konform!

🔧 USAGE:
   cd /opt/greiner-portal
   python3 sync_fibu_v2.5.1_BUGFIX.py
...
def kategorisiere_buchung(account: str, posting_text: str = '') -> str:
    ...
    BUGFIX v2.5.1: 
    - NUR 818xxx und 824xxx sind Wareneinsatz!
    - 810-817, 820-823, 825-829 sind Bilanz (Bestandsveränderungen)
    """
    ...
    # -------------------------------------------------------------------------
    # 3. GuV-KOSTEN (80-89) - NUR BESTIMMTE KONTEN!
    # -------------------------------------------------------------------------
    
    # 3.1 WARENEINSATZ FAHRZEUGE - NUR 818xxx und 824xxx! (BUGFIX!)
    elif '818000' <= account <= '818999':
        return 'wareneinsatz_fahrzeuge'
    elif '824000' <= account <= '824999':
        return 'wareneinsatz_fahrzeuge'
    ...
    # -------------------------------------------------------------------------
    # 4. ALLE ANDEREN = BILANZ (inkl. 810-817, 820-823, 825-829!)
    # -------------------------------------------------------------------------
    else:
        return 'bilanz'
...
def main():
    print("=" * 80)
    print("🚀 FIBU RE-KATEGORISIERUNG v2.5.1 - BWA-PERFEKT (BUGFIX!)")
    print("=" * 80)
    print(f"Datum: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
    print()
    print("🐛 BUGFIX: Nur 818xxx + 824xxx als Wareneinsatz (nicht 810-829!)")
    print()
    ...
    # Ausgabe
    print(f"{'Kategorie':<30} | {'BWA Soll':>15} | {'FIBU v2.5.1':>15} | {'Diff':>15}")
    print("-" * 90)
    ...
    print("🔍 WARENEINSATZ FAHRZEUGE (nur 818xxx + 824xxx):")
    print("-" * 60)
    ...
    # -------------------------------------------------------------------------
    print("=" * 80)
    print("🎉 ERFOLG! v2.5.1 KATEGORISIERUNG AKTIV!")
    print("=" * 80)

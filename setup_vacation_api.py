...
Vacation API Setup
==================
Erstellt die REST-API Struktur für den Urlaubsplaner
"""
...
# API Blueprint Code
API_BLUEPRINT = '''#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
...
def main():
    ...
    # API Blueprint
    api_file = api_dir / 'vacation_api.py'
    print(f"\n📝 Erstelle {api_file.name}...")
    with open(api_file, 'w', encoding='utf-8') as f:
        f.write(API_BLUEPRINT)
    print(f"   ✓ {api_file}")
    
    # __init__.py
    init_file = api_dir / '__init__.py'
    print(f"\n📝 Erstelle {init_file.name}...")
    ...
    print("\n📋 Erstelle API-Endpoints:")
    print("   ✓ GET  /api/vacation/health")
    print("   ✓ GET  /api/vacation/balance/<id>")
    print("   ✓ GET  /api/vacation/balance")
    print("   ✓ POST /api/vacation/request")
    print("   ✓ GET  /api/vacation/requests")
    print("   ✓ DELETE /api/vacation/request/<id>")
    print("   ✓ GET  /api/vacation/calendar")
    
    print("\n💡 Nächste Schritte:")
    print("   1. In app.py registrieren")
    print("   2. API testen")
    print("   3. Dokumentation erstellen")
    print()

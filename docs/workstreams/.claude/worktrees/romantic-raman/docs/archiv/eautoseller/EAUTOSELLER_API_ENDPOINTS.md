...
### 1. startdata.asp (Dashboard-Daten) ✅ FUNKTIONIERT
**URL:** `/administration/startdata.asp`  
**Method:** GET  
**Parameter:**
- `id`: Dashboard-Widget-ID (201, 202, 203, 204, 205, 206, 207, 210, 211, 212, 215, 225, 226, 228, 229, 231, 293, 294, 295, 296)
- `time`: Timestamp (wird dynamisch generiert, z.B. 1130, 4729)
- `intval`: Optional, Intervall (z.B. 8)

**Beispiel:**
```
GET /administration/startdata.asp?id=201&time=1130
GET /administration/startdata.asp?id=203&intval=8&time=1130
```
...
**Status:** ✅ Funktioniert! Gibt Dashboard-Daten zurück

...
- **Zielprämie: Doppeltes Gate bestätigt (2026-04-02):** Kumuliertes Gate bleibt aktiv: `kum_ist >= kum_ziel AND monats_ist >= monats_ziel`. Beide Bedingungen müssen erfüllt sein. Wenn Monatsziel erreicht: Zielerreichung (200€) + Übererfüllung (je 100€/Stk.).

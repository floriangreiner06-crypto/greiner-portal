-- KPI-Berechnung nach Locosoft-Logik (Position-basiert) - FINAL MIT FILTER
-- Datum: 2026-01-16 (TAG 194)
-- 
-- FILTER (basierend auf Excel-Analyse):
-- 1. Nur fakturierte Positionen (l.is_invoiced = true)
-- 2. Nur Positionen mit Stempelungen (EXISTS times)
...
stempelungen_mit_anteil AS (
    ...
    WHERE l.time_units > 0
        ...
        AND l.is_invoiced = true  -- FILTER: Nur fakturierte Positionen
),

-- KPI-Berechnung nach Locosoft-Logik (Position-basiert) - KORRIGIERT FINAL
-- Datum: 2026-01-16 (TAG 194)
-- 
-- WICHTIG: Wenn eine Stempelung auf mehrere Positionen gleichzeitig geht,
--          muss die Stempelzeit ANTEILIG verteilt werden basierend auf AW!
-- 
-- Beispiel: Stempelung 57 Min auf 5 Positionen (AW: 11, 3, 3, 1, 1 = 19 total)
--           Position 1.4: St-Ant. = 57 × (11/19) = 33 Min ✅

WITH
-- 1. Stempelungen MIT order_position (direkt zugeordnet)
--    WICHTIG: Wenn gleiche Start-/Endzeit auf mehrere Positionen → anteilige Verteilung!
stempelungen_roh AS (
...
-- 3. Anteiliger Stempelanteil pro Position

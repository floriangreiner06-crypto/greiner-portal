-- KPI-Berechnung nach Locosoft-Logik (Position-basiert)
-- Datum: 2026-01-16 (TAG 194)
-- 
-- Locosoft-Logik:
-- - Stempelanteil = Summe aller Stempelungen auf Auftragspositionen
-- - AW-Anteil = Anteilige Verteilung basierend auf Stempelzeit
-- - Leistungsgrad = (AW-Anteil / Stempelanteil) × 100

WITH
-- 1. Stempelungen auf Positionen zuordnen
--    Wenn order_position NULL: Alle Positionen des Auftrags (anteilige Verteilung)
stempelungen_mit_positionen AS (
    SELECT DISTINCT ON (t.employee_number, t.order_number, COALESCE(t.order_position, l.order_position), COALESCE(t.order_position_line, l.order_position_line), t.start_time, t.end_time)
        t.employee_number,
        t.order_number,
    ...
    ORDER BY t.employee_number, t.order_number, COALESCE(t.order_position, l.order_position), COALESCE(t.order_position_line, l.order_position_line), t.start_time, t.end_time
),
-- 2. Stempelanteil pro Position/Mechaniker

    ...
    <div class="content">
        ...
        <div style="margin: 30px 0; text-align: center;">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin: 20px 0;">
                <a href="""" + survey_url + """?choice=DRIVE&email=""" + email + """"
                ...
                <a href="""" + survey_url + """?choice=PULSE&email=""" + email + """"
                ...
                <a href="""" + survey_url + """?choice=CORE&email=""" + email + """"
                   style="display: block; background: #1e3a5f; color: white; padding: 20px; text-align: center; border-radius: 8px; text-decoration: none; font-weight: bold; font-size: 18px;">
                    ✅ CORE
                </a>
                <a href="""" + survey_url + """?choice=NEXUS&email=""" + email + """"
                   style="display: block; background: #1e3a5f; color: white; padding: 20px; text-align: center; border-radius: 8px; text-decoration: none; font-weight: bold; font-size: 18px;">
                    ✅ NEXUS
                </a>
            </div>

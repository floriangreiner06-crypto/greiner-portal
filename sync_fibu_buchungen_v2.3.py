...
# -*- coding: utf-8 -*-
"""
FIBU-Buchungen Sync v2.3 - ERWEITERTE BILANZKONTEN-KATEGORISIERUNG
===================================================================

Synchronisiert FIBU-Buchungen von Locosoft PostgreSQL nach SQLite
und kategorisiert sie KOMPLETT - inkl. aller relevanten Bilanzkonten!

WICHTIGE ÄNDERUNGEN v2.3:
- Erweiterte hart-codierte Sonderkonten (152001, 158001, 172001, 498001)
- Löst das komplette "181k € fehlen"-Problem!
- Sollte jetzt 100% Übereinstimmung mit BWA erreichen!

Neue Konten in v2.3:
- 152001 → wareneinsatz_fahrzeuge (Opel/Hyundai Lieferanten)
- 158001 → kosten_betrieb (Gemischte Betriebskosten)
- 172001 → wareneinsatz_fahrzeuge (Stellantis Netting)
- 498001 → kosten_sonstige (Kostenumlage zwischen Firmen)
...
# ============================================================================
# HART-CODIERTE SONDERKONTEN (v2.3 - ERWEITERT!)
# ============================================================================
...
SPECIAL_ACCOUNTS = {
    ...
    # v2.3 NEU - Die fehlenden 181k €:
    152001: 'wareneinsatz_fahrzeuge',   # Opel/Hyundai Lieferanten-Verrechnungen
    158001: 'kosten_betrieb',           # Gemischte Betriebskosten (Zinsen, Werbung, etc.)
    172001: 'wareneinsatz_fahrzeuge',   # Stellantis Netting (weitere IDs)
    498001: 'kosten_sonstige',          # Kostenumlage zwischen Firmen
}
...
def kategorisiere_erweitert_v3(nominal_account, posting_text, debit_credit):
    """
    Erweiterte Kategorisierung v2.3
    
    NEU: Mehr hart-codierte Bilanzkonten!
    ...
    # ========================================================================
    # 1. GuV-KONTEN (70-89) - WIE v2.1/v2.2
    # ========================================================================
    ...
    # ========================================================================
    # 2. v2.3: BILANZKONTEN MIT ERWEITERTEN HART-CODIERTEN KONTEN!
    # ========================================================================
...
def sync_fibu_buchungen():
    ...
    """
    print("=" * 80)
    print("FIBU-BUCHUNGEN SYNC v2.3 - ERWEITERTE BILANZKONTEN-KATEGORISIERUNG")
    print("=" * 80)
    print()
    ...
    for i, row in enumerate(buchungen, 1):
        ...
        # Kategorisierung v2.3 (mit erweiterten Konten!)
        kategorie = kategorisiere_erweitert_v3(nominal_acc, posting_text, debit_credit)
